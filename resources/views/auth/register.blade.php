			...
			{!! Form::open(['route' => 'register.process', 'method' => 'post', 'name' => 'sentMessage'. 'id' => 'contactForm', 'novalidate']) !!}
				...
				<div class="row control-group">
					<div class="form-group col-xs-12 floating-label-form-group controls">
						...
						{!! Form::text('password', null, ['id' => 'password', 'class' => 'form-control', 'placeholder' => '密碼', 'data-validation-required-message' => '請輸入密碼', 'required']) !!}
						<p class="help-block text-danger" style="color: red;">{!! $errors->first('email') !!}</p>
					</div>
				</div>
				<div class="row control-group">
					<div class="form-group col-xs-12 floating-label-form-group controls">
						...
						{!! Form::text('password_confirmation', null, ['id' => 'password_confirmation', 'class' => 'form-control', 'placeholder' => '確認密碼', 'data-validation-required-message' => '請輸入確認密碼', 'required']) !!}
						<p class="help-block text-danger" style="color: red;">{!! $errors->first('email') !!}</p>
					</div>
				</div>
				<br>
